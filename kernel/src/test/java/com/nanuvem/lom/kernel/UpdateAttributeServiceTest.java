...
//					+ "\"minlength\": 5,\"maxlength\": 15}";
	...
	public void validNewName() {
		...
		Attribute createdAttribute = createOneAttribute(attributeService, "abc.a", null, "pa", LONGTEXT, null);

		Attribute updatedAttribute =
				updateAttribute(attributeService, "abc.a", createdAttribute, 1, "pb", LONGTEXT, null);
	...
	public void validNewSequence() {
		ClassHelper.createClass(classService, "abc", "a");
		Attribute createdAttribute1 = createOneAttribute(attributeService, "abc.a", null, "pa", TEXT, null);
		Attribute createdAttribute2 = createOneAttribute(attributeService, "abc.a", null, "pb", TEXT, null);

		Attribute updatedAttribute1 =
				updateAttribute(attributeService, "abc.a", createdAttribute1, 2, "pa", TEXT, null);
		verifyUpdatedAttribute(createdAttribute1, updatedAttribute1);

		Attribute updatedAttribute2 =
				updateAttribute(attributeService, "abc.a", createdAttribute2, 2, "pb", TEXT, null);
		verifyUpdatedAttribute(createdAttribute2, updatedAttribute2);

		Attribute updatedAttribute3 =
				updateAttribute(attributeService, "abc.a", updatedAttribute2, 1, "pb", TEXT, null);
	...
	public void invalidNewSequence() {
		...
		Attribute createdAttribute = createOneAttribute(attributeService, "abc.a", null, "pa", TEXT, null);

		createOneAttribute(attributeService, "abc.a", null, "pb", TEXT, null);

		expectExceptionOnUpdateInvalidAttribute(attributeService, "abc.a", createdAttribute, null, "pa", LONGTEXT,
				null, "Invalid value for Attribute sequence: null");
		expectExceptionOnUpdateInvalidAttribute(attributeService, "abc.a", createdAttribute, -1, "pa", LONGTEXT, null,
				"Invalid value for Attribute sequence: -1");
		expectExceptionOnUpdateInvalidAttribute(attributeService, "abc.a", createdAttribute, 0, "pa", LONGTEXT, null,
				"Invalid value for Attribute sequence: 0");
		expectExceptionOnUpdateInvalidAttribute(attributeService, "abc.a", createdAttribute, 3, "pa", LONGTEXT, null,
	...
	public void changeType() {
		...
		expectExceptionOnUpdateInvalidAttribute(attributeService, "abc.a", createdAttribute, 1, "pa", null, null,
	...
	public void renamingConflicts() {
		...
		Attribute createdAttribute2 = createOneAttribute(attributeService, "abc.b", null, "pb", TEXT, null);
		Attribute createdAttribute3 = createOneAttribute(attributeService, "abc.a", null, "pc", TEXT, null);

		Attribute updatedAttribute2 =
				updateAttribute(attributeService, "abc.b", createdAttribute2, 1, "pa", TEXT, null);
		verifyUpdatedAttribute(createdAttribute2, updatedAttribute2);

		expectExceptionOnUpdateInvalidAttribute(attributeService, "abc.a", createdAttribute3, 1, "pa", TEXT, null,
	...
	public void genericChangeConfiguration() {
		...
		Attribute createdAttribute1 =
				createOneAttribute(attributeService, "abc.a", null, "pa", TEXT, CONFIGURATION_MANDATORY_TRUE);

		Attribute createdAttribute2 = createOneAttribute(attributeService, "abc.a", null, "pb", TEXT, null);

		Attribute updatedAttribute11 =
				updateAttribute(attributeService, "abc.a", createdAttribute1, 1, "pa", TEXT, "{\"mandatory\":false}");
		verifyUpdatedAttribute(createdAttribute1, updatedAttribute11);

		Attribute updatedAttribute12 =
				updateAttribute(attributeService, "abc.a", updatedAttribute11, 2, "pa", TEXT, null);
		verifyUpdatedAttribute(updatedAttribute11, updatedAttribute12);

		Attribute updatedAttribute2 =
				updateAttribute(attributeService, "abc.a", createdAttribute2, 2, "pb", TEXT,
	...
	public void validChangeConfigurationForTextAttributeType() {
		...
		Attribute createdAttribute1 =
				createOneAttribute(attributeService, "abc.a", null, "pa", TEXT, CONFIGURATION_MANDATORY_TRUE);
		Attribute createdAttribute2 =
				createOneAttribute(attributeService, "abc.a", null, "pb", TEXT, TEXT_CONFIGURATION_COMPLETE);

		Attribute updatedAttribute11 =
				updateAttribute(attributeService, "abc.a", createdAttribute1, 1, "pa", TEXT, TEXT_CONFIGURATION_PARTIAL);
		verifyUpdatedAttribute(createdAttribute1, updatedAttribute11);

		Attribute updatedAttribute12 =
				updateAttribute(attributeService, "abc.a", updatedAttribute11, 1, "pa", TEXT,
						TEXT_CONFIGURATION_COMPLETE);
		verifyUpdatedAttribute(updatedAttribute11, updatedAttribute12);

		Attribute updatedAttribute21 =
				updateAttribute(attributeService, "abc.a", createdAttribute2, 2, "pb", TEXT, TEXT_CONFIGURATION_PARTIAL);
		verifyUpdatedAttribute(createdAttribute2, updatedAttribute21);

		Attribute updatedAttribute22 =
				updateAttribute(attributeService, "abc.a", updatedAttribute21, 2, "pb", TEXT,
						CONFIGURATION_MANDATORY_TRUE);
		verifyUpdatedAttribute(updatedAttribute21, updatedAttribute22);

		Attribute updatedAttribute23 =
				updateAttribute(attributeService, "abc.a", updatedAttribute22, 2, "pb", TEXT, "{\"default\":\"abc\"}");
		verifyUpdatedAttribute(updatedAttribute22, updatedAttribute23);

		Attribute updatedAttribute24 =
				updateAttribute(attributeService, "abc.a", updatedAttribute23, 2, "pb", TEXT, "{\"default\":\"123\"}");
	...
	public void invalidChangeConfigurationForTextAttributeType() {
		...
		expectExceptionOnUpdateInvalidAttribute(attributeService, "abc.a", createdAttribute, 1, "pa", TEXT,
				...
				"Invalid configuration for attribute pa: the mandatory value must be true or false literals");
		expectExceptionOnUpdateInvalidAttribute(attributeService, "abc.a", createdAttribute, 1, "pa", TEXT,
				"{\"default\":10}", "Invalid configuration for attribute pa: the default value must be a string");
		expectExceptionOnUpdateInvalidAttribute(attributeService, "abc.a", createdAttribute, 1, "pa", TEXT,
				"{\"regex\":10}", "Invalid configuration for attribute pa: the regex value must be a string");
		expectExceptionOnUpdateInvalidAttribute(attributeService, "abc.a", createdAttribute, 1, "pa", TEXT,
				"{\"minlength\":\"abc\"}",
	...
	public void validChangeConfigurationForLongTextAttributeType() {
		...
		Attribute createdAttribute1 =
				createOneAttribute(attributeService, "abc.a", null, "pa", LONGTEXT, CONFIGURATION_MANDATORY_TRUE);
		Attribute createdAttribute2 =
				createOneAttribute(attributeService, "abc.a", null, "pb", LONGTEXT, LONGTEXT_CONFIGURATION_COMPLETE);

		Attribute updatedAttribute11 =
				updateAttribute(attributeService, "abc.a", createdAttribute1, 1, "pa", LONGTEXT,
						LONGTEXT_CONFIGURATION_PARTIAL);
		verifyUpdatedAttribute(createdAttribute1, updatedAttribute11);

		Attribute updatedAttribute12 =
				updateAttribute(attributeService, "abc.a", updatedAttribute11, 1, "pa", LONGTEXT,
						LONGTEXT_CONFIGURATION_COMPLETE);
		verifyUpdatedAttribute(updatedAttribute11, updatedAttribute12);

		Attribute updatedAttribute21 =
				updateAttribute(attributeService, "abc.a", createdAttribute2, 2, "pb", LONGTEXT,
						LONGTEXT_CONFIGURATION_PARTIAL);
		verifyUpdatedAttribute(createdAttribute2, updatedAttribute21);

		Attribute updatedAttribute22 =
				updateAttribute(attributeService, "abc.a", updatedAttribute21, 2, "pb", LONGTEXT,
						CONFIGURATION_MANDATORY_TRUE);
		verifyUpdatedAttribute(updatedAttribute21, updatedAttribute22);

		Attribute updatedAttribute23 =
				updateAttribute(attributeService, "abc.a", updatedAttribute22, 2, "pb", LONGTEXT,
						"{\"default\":\"abc\"}");
		verifyUpdatedAttribute(updatedAttribute22, updatedAttribute23);

		Attribute updatedAttribute24 =
				updateAttribute(attributeService, "abc.a", updatedAttribute23, 2, "pb", LONGTEXT,
						"{\"default\":\"123\"}");
		verifyUpdatedAttribute(updatedAttribute23, updatedAttribute24);
	...
	public void validChangeConfigurationForPasswordAttributeType() {
		...
		Attribute createdAttribute1 =
				createOneAttribute(attributeService, "abc.a", null, "pa", PASSWORD, CONFIGURATION_MANDATORY_TRUE);
		Attribute createdAttribute2 =
				createOneAttribute(attributeService, "abc.a", null, "pb", PASSWORD, PASSWORD_CONFIGURATION_COMPLETE);

		Attribute updatedAttribute11 =
				updateAttribute(attributeService, "abc.a", createdAttribute1, 1, "pa", PASSWORD,
						PASSWORD_CONFIGURATION_PARTIAL);
		verifyUpdatedAttribute(createdAttribute1, updatedAttribute11);

		Attribute updatedAttribute12 =
				updateAttribute(attributeService, "abc.a", updatedAttribute11, 1, "pa", PASSWORD,
						PASSWORD_CONFIGURATION_COMPLETE);
		verifyUpdatedAttribute(updatedAttribute11, updatedAttribute12);

		Attribute updatedAttribute21 =
				updateAttribute(attributeService, "abc.a", createdAttribute2, 2, "pb", PASSWORD,
						PASSWORD_CONFIGURATION_PARTIAL);
		verifyUpdatedAttribute(createdAttribute2, updatedAttribute21);

		Attribute updatedAttribute22 =
				updateAttribute(attributeService, "abc.a", updatedAttribute21, 2, "pb", PASSWORD,
						CONFIGURATION_MANDATORY_TRUE);
		verifyUpdatedAttribute(updatedAttribute21, updatedAttribute22);

		Attribute updatedAttribute23 =
				updateAttribute(attributeService, "abc.a", updatedAttribute22, 2, "pb", PASSWORD,
						"{\"default\":\"abc\"}");
		verifyUpdatedAttribute(updatedAttribute22, updatedAttribute23);

		Attribute updatedAttribute24 =
				updateAttribute(attributeService, "abc.a", updatedAttribute23, 2, "pb", PASSWORD,
						"{\"default\":\"123\"}");
		verifyUpdatedAttribute(updatedAttribute23, updatedAttribute24);
	}
	...
	public void invalidChangeConfigurationForPaswordAttributeType() {
		ClassHelper.createClass(classService, "abc", "a");
		Attribute createdAttribute = createOneAttribute(attributeService, "abc.a", null, "pa", PASSWORD, null);
	...
	private void expectExceptionOnUpdateWithInvalidNewName(Attribute createdAttribute, String invalidNewName,
			String exceptedMessage) {
		expectExceptionOnUpdateInvalidAttribute(attributeService, "abc.a", createdAttribute, 1, invalidNewName,
				LONGTEXT, null, exceptedMessage);
	}

	private void verifyUpdatedAttribute(Attribute attributeBeforeUpgrade, Attribute updatedAttribute) {
		...
		Attribute listedAttribute = attributeService.findAttributeById(attributeBeforeUpgrade.getId());
