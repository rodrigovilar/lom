...
public class UpdateAttributeServiceTest {
	...
	public void validNewSequence() {
		...
		Attribute updatedAttribute1 =
				updateAttribute(attributeService, "abc.a", createdAttribute1, 2, "pa", LONGTEXT, null);
		verifyUpdatedAttribute(createdAttribute1, updatedAttribute1);

		Attribute updatedAttribute2 =
				updateAttribute(attributeService, "abc.a", createdAttribute2, 2, "pb", LONGTEXT, null);
		verifyUpdatedAttribute(createdAttribute2, updatedAttribute2);

		Attribute updatedAttribute3 =
				updateAttribute(attributeService, "abc.a", updatedAttribute2, 1, "pb", LONGTEXT, null);
		verifyUpdatedAttribute(updatedAttribute2, updatedAttribute3);

		Attribute updatedAttribute4 =
				updateAttribute(attributeService, "abc.a", updatedAttribute3, null, "pb", LONGTEXT, null);
	...
	public void genericChangeConfiguration() {
		...
		Attribute updatedAttribute12 =
				updateAttribute(attributeService, "abc.a", updatedAttribute11, 1, "pa", TEXT, null);
	...
	private void verifyUpdatedAttribute(Attribute createdAttribute, Attribute updatedAttribute) {
		Assert.assertNotNull("updatedAttribute.id should not be null", updatedAttribute.getId());
		Assert.assertEquals("updatedAttribute.version should be 1", 1, (int) updatedAttribute.getVersion());
		Attribute listedAttribute = attributeService.findAttributeById(createdAttribute.getId());
		Assert.assertEquals("listedAttribute should be to updatedAttribute", updatedAttribute, listedAttribute);
		Assert.assertFalse("listedAttribute should be to createdAttribute", createdAttribute.equals(listedAttribute));
	}
}
